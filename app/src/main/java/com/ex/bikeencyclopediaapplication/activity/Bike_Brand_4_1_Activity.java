...
public class Bike_Brand_4_1_Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_4_1_bike_brand);
    ...
    public void onClick(View view) {
        ...
        Intent specialized = new Intent(Bike_Brand_4_1_Activity.this, Specialized_Activity.class);
