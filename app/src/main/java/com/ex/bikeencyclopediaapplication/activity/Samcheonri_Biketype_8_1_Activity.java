...
public class Samcheonri_Biketype_8_1_Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_8_1_samcheonri_biketype);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.samcheonri_road_button:
                Intent samcheonri_road_button = new Intent(Samcheonri_Biketype_8_1_Activity.this,
                        Samcheonri_Road_9_1_Activity.class);
                startActivity(samcheonri_road_button);
                break;

            case R.id.samcheonri_mtb_button :
                Intent samcheonri_mtb_button = new Intent(Samcheonri_Biketype_8_1_Activity.this,
